  ...
  apply(ctx) {
    ...
    function Dashboard(_props) {
      ...
      return React.createElement('div', { style: { padding: 16 } },
        ...
        React.createElement('p', null, state.health ? `uptime ${Math.round(state.health.uptimeMs / 60000)}m \u00B7 ${state.health.toolCount} tools \u00B7 ${state.health.plugins.length} plugins` : 'health \u2026'),
