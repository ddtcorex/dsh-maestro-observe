...
4. Open the project in your editor. Host logic lives in `src/host/`, client dashboard in `client/`, tests in `tests/`. `lib/` is committed build output — do not hand-edit.
